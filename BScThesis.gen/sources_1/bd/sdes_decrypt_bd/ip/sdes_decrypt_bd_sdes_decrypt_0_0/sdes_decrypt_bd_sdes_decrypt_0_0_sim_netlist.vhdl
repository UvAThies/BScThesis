...
--               c:/Users/Thies/xillinx/BScThesis/BScThesis.gen/sources_1/bd/sdes_decrypt_bd/ip/sdes_decrypt_bd_sdes_decrypt_0_0/sdes_decrypt_bd_sdes_decrypt_0_0_sim_netlist.vhdl
...
architecture STRUCTURE of sdes_decrypt_bd_sdes_decrypt_0_0 is
  ...
  signal \inst/sdes_decrypt_instance/pi1/bits_left1\ : STD_LOGIC_VECTOR ( 1 downto 0 );
  signal \inst/sdes_decrypt_instance/pi1/bits_right1\ : STD_LOGIC_VECTOR ( 1 downto 0 );
  signal \inst/sdes_decrypt_instance/pi1/p_0_in\ : STD_LOGIC;
  signal \inst/sdes_decrypt_instance/pi2/bits_left1\ : STD_LOGIC_VECTOR ( 1 downto 0 );
  signal \inst/sdes_decrypt_instance/pi2/bits_right1\ : STD_LOGIC_VECTOR ( 1 downto 0 );
  signal \inst/sdes_decrypt_instance/pi2/p_0_in\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \m_axis_tdata[7]_INST_0_i_5\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \m_axis_tdata[7]_INST_0_i_6\ : label is "soft_lutpair3";
...
\m_axis_tdata[7]_INST_0_i_6\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"6"
    )
        port map (
