...
(* CORE_GENERATION_INFO = "design_1,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=design_1,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=6,numReposBlks=6,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=1,numPkgbdBlks=0,bdsource=USER,da_board_cnt=2,da_clkrst_cnt=1,da_ps7_cnt=1,synth_mode=Hierarchical}" *) (* HW_HANDOFF = "design_1.hwdef" *) 
module design_1
   (DDR_addr,
    DDR_ba,
    DDR_cas_n,
  ...
  wire [0:7]SDES_encrypt_0_output;
  wire [17:0]ilconstant_0_dout;
  wire [25:0]processing_system7_0_GPIO_O;
  ...
  design_1_xlconcat_0_0 xlconcat_0
       (.In0(ilconstant_0_dout),
        .In1({SDES_encrypt_0_output[0],SDES_encrypt_0_output[1],SDES_encrypt_0_output[2],SDES_encrypt_0_output[3],SDES_encrypt_0_output[4],SDES_encrypt_0_output[5],SDES_encrypt_0_output[6],SDES_encrypt_0_output[7]}),
        .dout(xlconcat_0_dout));
  design_1_xlslice_0_0 xlslice_0
       (.Din(processing_system7_0_GPIO_O[24:0]),
        .Dout(xlslice_0_Dout));
