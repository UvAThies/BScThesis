...
--               c:/Users/Thies/xillinx/BScThesis/BScThesis.gen/sources_1/bd/sdes_encrypt_bd/ip/sdes_encrypt_bd_sdes_encrypt_0_0_6/sdes_encrypt_bd_sdes_encrypt_0_0_sim_netlist.vhdl
...
entity sdes_encrypt_bd_sdes_encrypt_0_0_SDES_encrypt is
  port (
  ...
  attribute ORIG_REF_NAME of sdes_encrypt_bd_sdes_encrypt_0_0_SDES_encrypt : entity is "SDES_encrypt";
end sdes_encrypt_bd_sdes_encrypt_0_0_SDES_encrypt;

architecture STRUCTURE of sdes_encrypt_bd_sdes_encrypt_0_0_SDES_encrypt is
  signal \^ar\ : STD_LOGIC_VECTOR ( 0 to 0 );
  signal \outp[0]_i_4_n_0\ : STD_LOGIC;
  signal \outp[0]_i_6_n_0\ : STD_LOGIC;
  signal \outp[2]_i_4_n_0\ : STD_LOGIC;
  signal \outp[3]_i_2_n_0\ : STD_LOGIC;
  signal \outp[4]_i_4_n_0\ : STD_LOGIC;
  signal \pi1_instance/bits_left1\ : STD_LOGIC_VECTOR ( 1 downto 0 );
  signal \pi1_instance/bits_right1\ : STD_LOGIC_VECTOR ( 1 downto 0 );
  signal \pi1_instance/p_0_in\ : STD_LOGIC;
  signal pi1_outp : STD_LOGIC_VECTOR ( 0 to 3 );
  signal \pi2_instance/bits_left1\ : STD_LOGIC_VECTOR ( 1 downto 0 );
  signal \pi2_instance/bits_right1\ : STD_LOGIC_VECTOR ( 1 downto 0 );
  signal pi2_outp : STD_LOGIC_VECTOR ( 0 to 3 );
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \outp[0]_i_6\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \outp[0]_i_7\ : label is "soft_lutpair3";
...
begin
  AR(0) <= \^ar\(0);
\outp[0]_i_1\: unisim.vcomponents.LUT6
    generic map(
...
\outp[0]_i_6\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"6"
    )
        port map (
...
\outp[1]_i_1\: unisim.vcomponents.LUT6
    generic map(
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity sdes_encrypt_bd_sdes_encrypt_0_0_axi_interface_sdes_encrypt is
  port (
    m_axis_tdata : out STD_LOGIC_VECTOR ( 7 downto 0 );
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of sdes_encrypt_bd_sdes_encrypt_0_0_axi_interface_sdes_encrypt : entity is "axi_interface_sdes_encrypt";
end sdes_encrypt_bd_sdes_encrypt_0_0_axi_interface_sdes_encrypt;

architecture STRUCTURE of sdes_encrypt_bd_sdes_encrypt_0_0_axi_interface_sdes_encrypt is
  ...
  signal sdes_encrypt_instance_n_0 : STD_LOGIC;
...
sdes_encrypt_instance: entity work.sdes_encrypt_bd_sdes_encrypt_0_0_SDES_encrypt
     port map (
      AR(0) => sdes_encrypt_instance_n_0,
...
inst: entity work.sdes_encrypt_bd_sdes_encrypt_0_0_axi_interface_sdes_encrypt
     port map (
      aclk => aclk,
      aresetn => aresetn,
      m_axis_tdata(7 downto 0) => \^m_axis_tdata\(7 downto 0),
