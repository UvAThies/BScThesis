...
HD_PWD='C:/Users/Thies/xillinx/BScThesis/BScThesis.srcs/sources_1/bd/myproj/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log des_encrypt_bd_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source des_encrypt_bd_wrapper.tcl
